...
public class HocSinhCap3 extends HocSinh{
    ...
    public void nhapThongTin() {
        ...
        this.diemTiengAnh = idv.nextFloat();
        System.out.println();
    }
    ...
    public void xuatThongTin() {
        ...
        System.out.println(String.format("Diem Tieng Anh: %.2f", this.diemTiengAnh));
    ...
    public float diemTrungBinh(){
        return (this.diemToan + this.diemVan + this.diemTiengAnh) / 3;
    }
}
